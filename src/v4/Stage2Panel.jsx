...
export default function Stage2Panel({
  ...
  return (
    <div style={{ maxWidth: 720, padding: 16 }}>
      ...
      {!stage2.summary && (
        <InvalidStage2Banner stage2={stage2} />
      )}
...
function InvalidStage2Banner({ stage2 }) {
    ...
    <div style={{
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 7 }}>
        ...
        <div style={{ fontSize: 9, fontFamily: 'var(--fm)', color: 'var(--muted)' }}>
          Re-run Stage 2 to retry. If this recurs, check the API response token limit or inspect the raw session in localStorage.
        </div>
